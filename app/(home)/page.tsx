...
function page() {
  return (
    <div>
      ...
      <h3 className='text-2xl text-gray-400 flex mt-3 justify-center items-center'>Meet our Team!!</h3>
      <ThreeDCardDemo/>
      {/*<h1 className='text-7xl text-gray-400 flex justify-center items-center mb-[6%]'>Timeline</h1>*/}
      <h1 className='text-7xl text-gray-400 flex justify-center items-center mb-2'>Gallery</h1>
      {/* <Gallery/> */}
      <Page/>
      {/*<BentoGridDemo/>*/}
